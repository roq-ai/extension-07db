...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'task.create.create': {
    roles: ['owner', 'team-member', 'administrator', 'end-user', 'developer'],
    key: 'task',
    tenantPath: [],
    userPath: [],
  },
  ...
  'bug.resolve.update': { roles: ['owner', 'team-member', 'developer'], key: 'bug', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['owner', 'team-member', 'administrator', 'end-user', 'developer'];
