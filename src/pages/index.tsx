  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Extension: Revolutionizing the way you browse with our unique tool. Scrape, share, and explore the web like never before."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1590595906931-81f04f0ccebb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxicm93c2VyJTIwZXh0ZW5zaW9ufGVufDB8fHx8MTY5NTM2MjEyMHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@richygreat?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Richy Great`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Extension: Revolutionizing the way you browse with our unique tool. Scrape, share, and explore the web like never before.`}
            </Text>
            <Box
